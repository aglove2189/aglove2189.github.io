...
\documentclass[13pt, letterpaper]{awesome-cv} % A4 paper size by default, use 'letterpaper' for US letter
...
\quote{A highly skilled Machine Learning Engineering Manager with over a decade of experience in developing predictive models and data-driven solutions. Proven track record in leading teams, optimizing production processes, driving significant cost savings, and generating revenue. Expertise in Python, modeling, mlops, devops, and cloud platforms.}
